...
public class TICTACTOE_SIMBT {

	private JFrame frame;
	private JTextField xCount;
	private JTextField oCount;
	private int xCount1=0;     //INITIALLY COUNT WILL REMAIN 0 FOR BOTH PLAYERS
	private int oCount1=0;
	private String startGame="X";  //game always starts with x 
	private int b1=10;
	private int b2=10;
	private int b3=10;
	private int b4=10;
	private int b5=10;  // random values by which we can compare the variables and store the points into count button
	private int b6=10;
	private int b7=10;
	private int b8=10;
	private int b9=10;
	private int i=0; //THIS VARIABLE IS USED TO GENERATE STATEMENT FOR GAME DRAW
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TICTACTOE_SIMBT  window = new TICTACTOE_SIMBT ();
	 ...
	 */
	public TICTACTOE_SIMBT()  {
		initialize();
	}

	

	//FUNCITON FOR COMPARING PLAYER POINTS AND INCREASING THE WINNING POINT FOR EACH PLAYERS
